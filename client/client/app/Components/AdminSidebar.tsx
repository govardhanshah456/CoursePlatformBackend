...
import { BarChartOutlined, CreateRounded, OndemandVideoOutlined, PeopleOutlineOutlined, Settings, VideoCallOutlined } from "@mui/icons-material";
            ...
            >
                <Menu iconShape="square">
                    ...
                    <Box paddingLeft={isCollapsed ? undefined : "10%"}>
                        ...
                        />
                        <Typography variant="h5" sx={{ m: "15px 0 5px 25px" }} className="text-[10px] text-black dark:text-white capitalize font-[400]">
                            {!isCollapsed && "Data"}
                        </Typography>
                        <Item
                            title="Users"
